          ...
          >
            <div className="flex gap-2.5 max-w-sm mx-auto">
              ...
              <a
                ...
                className="inline-flex items-center justify-center size-14 rounded-full border-2 border-border bg-card text-foreground active:scale-95 transition-transform shrink-0 hover:border-primary hover:text-primary"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="size-5" aria-hidden="true">
